...
KFS_TEST(test_abs_zero) { KFS_ASSERT_EQ(0, kfs_abs(0)); }

KFS_TEST(test_abs_positive) { KFS_ASSERT_EQ(5, kfs_abs(5)); }

KFS_TEST(test_abs_negative) { KFS_ASSERT_EQ(7, kfs_abs(-7)); }
